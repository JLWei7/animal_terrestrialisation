...
In addition, we extracted the intersected Pfam domains as well.
...
For both GO terms intersection of novel and novel core HGs, and HGs intersection for expanded, contracted and lost HGs, we use library [UpSetR](https://cran.r-project.org/web/packages/UpSetR/vignettes/basic.usage.html) to generate upset diagrams for visualization. We here give an example script of UpSet diagram plotting with novel genes Pfams, please see **03_functional_analysis/scripts/example_upset_diagram_with_novel_pfams.R** and input data **03_functional_analysis/novel_novel_core/intersection_Pfams/novel/pfams_novel_event** for reproducibility.