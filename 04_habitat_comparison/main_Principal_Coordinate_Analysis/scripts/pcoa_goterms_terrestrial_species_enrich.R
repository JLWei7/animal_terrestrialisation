...
df <- read.csv("novel_goterms_terrestrialspecies_df.csv",
...
# Save results
write.csv(fisher_df, "goterms_fisher_all_features.csv", row.names = FALSE)
write.csv(sig, "goterms_fisher_significant_enriched.csv", row.names = FALSE)
